...
gfsd_modify_preview_phrase (GtkButton *button, GnomePrintFontDialog *fontseldiag)
{
	...
	ghex_utils_set_atk_relation (entry, label, ATK_RELATION_LABELLED_BY);
...
gnome_print_font_dialog_init (GnomePrintFontDialog *fontseldiag)
{
	...
	ghex_utils_set_atk_relation (preview_frame, fontseldiag->fontsel, 
							ATK_RELATION_CONTROLLED_BY);
	ghex_utils_set_atk_relation (fontseldiag->fontsel, preview_frame, 
 ...
 * Copied from gedit. Shivram U - 12th Dec 2002
 */
void
ghex_utils_set_atk_relation (  GtkWidget *obj1,
			       GtkWidget *obj2,
